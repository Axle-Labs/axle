---
title: "Axle's Docs MCP"
description: "Set up Axle's Docs MCP to grant AI tools the knowledge of Axle docs"
---

If you use AI-powered tools like like Cursor, VS Code Copilot, or Claude Desktop to build your Axle integrations, you can now link these tools directly to the Axle docs for faster integration building!
...
This is an early alphabeta feature, so expect that these instructions may change due to updates from Mintlify or from the MCP Clients (Cursor, VS Code, Claude, etc.)
...
We also recommend installing an MCP compatible IDE or Chatbot tool before you begin this setup process. As of today, these primarily include VS Code, Cursor, and Claude Desktop.
...
Once you’ve completed the MCP installation, you can simply ask your chatbot of choice a questions about the Axle docs.
