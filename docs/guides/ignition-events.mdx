...
- `user` (optional in production; required in the sandbox) - optional user to attach. Please refer to [startIgnition](/api-reference/ignition/start-ignition) for more details.
