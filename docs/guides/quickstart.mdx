...
<Warning>
  Never send requests from your application's client to the Axle API. Making
  requests from your application's protected services will avoid exposing your
  sensitive Axle API credentials.
</Warning>
...
<Tip>
  ...
  requirements, refer to our [Initialize Ignition](/guides/initialize-ignition)
  guide.
</Tip>

Then, process events generated during the course of the Ignition session. See our [Ignition events](/guides/ignition-events) guide for each Ignition event.
