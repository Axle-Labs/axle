...
The following policies are recommended for testing:
...
- `pol_sandbox_4` - Returns `fail` for the `rental-covered-for-collision` Rule because the policy does not have collision coverage
