...
```
  ...
  **Evaluation Criteria**
  ...
  The Rule is evaluated based on the following two criterias. Both of these criteria must be true for the `collision-coverage-meets-requirements` Rule to resolve to `pass`.
