...
```
  ...
  <Accordion title="Does Collision Coverage Meet Requirements?">
  ...
  **Example Usage**
  ...
  <Accordion title="Does Comprehensive Coverage Meet Requirements?">
  ...
  <Accordion title="Insureds Match">
    ...
    **Example Usage**
    ...
    <Accordion title="Do Fields or Declarations Page Exist?">
    ### `fields-or-declarations-page-exist`
    ...
    ```typescript Example Rule Request
    {
      "rule": "fields-or-declarations-page-exist",
      "input": {
         "requiredFields": {
            "carrier": true,
            "isActive": true,
    ...
    "fields-or-declarations-page-exist": {
        "status": "pass",
        "summary": {
            "fields-or-declarations-page-exist": "pass"
        },
        "rules": {
            "fields-or-declarations-page-exist": {
                "status": "pass",
