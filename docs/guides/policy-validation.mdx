...
<Steps>
  ...
  <Step title="Retrieve Validation Templates">
    ...
    See [Get Validation Config](/api-reference/configs/get-config-validation) or [Get Client Validation Config](/api-reference/platform/get-client-config-validation) for more details.
  </Step>
