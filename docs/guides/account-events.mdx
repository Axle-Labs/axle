...
When identifying details on the Account change. Refer to [Account](/api-reference/accounts/account) for more information on all the attributes that can be modified.
