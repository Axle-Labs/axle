...
When identifying details on the Policy change. Refer to the [Policy](/api-reference/policies/policy) object reference for more details on the attributes that can be modified.
