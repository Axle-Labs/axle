...
<Tip>
  ...
  a user's insurance information will increase the open rate of Ignition. 
  
  We also recommend including a link our [consumers](https://www.axle.insure/consumers) page in case your users have additional questions. Reach out to the Axle team for any guidance on how to
