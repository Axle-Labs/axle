...
<Warning>
  Monitoring is not enabled by default and requires user consent. Please contact
  the Axle team if you would like to enable this feature!
</Warning>

#### How it works

### Step 1: Configure Ignition to receive webhooks
...
### Step 2: Process Account and Policy events
...
### Step 3: Retrieve Account or Policy object
...
### Step 4: Validate against requirements and contact user if action is required
