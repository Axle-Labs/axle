...
<ParamField body="refreshedAt" type="string">
  ...
  <Tip>
    If the `refreshedAt` date does not update daily, this indicates that we are working to re-establish the connection with the 
    insurance carrier to retrieve updated account data. 
  </Tip>
</ParamField>
