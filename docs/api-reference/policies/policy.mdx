            ...
            <Expandable title="Vehicle">
                ...
                <ResponseField name="make" type="string or null">
                 ...
                 <ResponseField name="use" type="string or null">
                  The “vehicle use” or “primary use” of the vehicle, indicating how the insured vehicle is predominantly used in everyday life.

                  Available options:
                  1. `pleasure` - Used for personal or recreational driving, typically with minimal daily mileage.
                  2. `commute` - Used primarily for traveling to and from work or school on a regular basis.
                  3. `business` - Used for business-related tasks, such as client visits or traveling during work.
                  4. `farm` - Used mainly for agricultural or farm-related activities.
