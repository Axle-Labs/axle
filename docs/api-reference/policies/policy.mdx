...
List of coverage types and levels offered by the policy.
    ...
    <Expandable title="Coverage">
        ...
        <ResponseField name="limitPerPerson" type="integer<int32>" optional />

        <ResponseField name="limitPerAccident" type="integer<int32>" optional />

        <ResponseField name="deductible" type="integer<int32>" optional />
...
List of documents (such as declaration pages and policy agreements) associated with the policy.
    ...
    <Expandable title="Document">
        ...
        <ResponseField name="source" type="string">
          ...
          <Tip>
            User-provided documents are unverified by Axle.
          </Tip>
...
<Tip>
  All fields are nullable and non-optional unless otherwise specified. See [API
